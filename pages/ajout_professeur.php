...
<title>Nouveau Professeur - GeMarge ::: Logiciel D'émargement</title>
<!--sub-heard-part-->
								  ...
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
											<h2 class="inner-tittle">Nouveau Professeur</h2>
<!--DEBUT CONTENU-->
<div class="form-body">
<div data-example-id="simple-form-inline"> 
<form class="form-inline" action="traitement/ajout_prof.php" method="post"> 
<div class="col-lg-3"> 
Votre nom: <input type="text" class="control-label form-control" name="nom" value="" required="required" />
</div>
<div class="col-lg-3"> 
Prenoms: <input type="text" class="control-label form-control" name="prenoms" value="" required="required" />
</div>
<div class="col-lg-3"> 
Date de Naissnace: <input type="date" class="control-label form-control" name="date_nai" value="" required="required" />
</div> 
<div class="col-lg-3"> 
Choix du sexe:
...
<div class="col-lg-3"> 
Contact: <input type="contact" class="control-label form-control" name="contact" value="" required="required" />
</div>
<div class="col-lg-3"> 
Adresse: <input type="text" class="control-label form-control" name="adresse" value="" />
</div>
<div class="col-lg-3"> 
Email: <input type="email" class="control-label form-control" name="email" value="" />
</div>
<div class="col-lg-3"> 
Profession: <input type="text" class="control-label form-control" name="profession" value="" />
</div>
<div class="col-lg-3"> 
Dernier Diplôme: <input type="text" class="control-label form-control" name="diplome" value="" />
</div>
<div class="col-lg-3"> 
Photo: <input type="file" class="control-label form-control" name="photo" value="" />
</div>
<div class="col-lg-3"> 
 <input type="submit" class="control-label form-control" name="go" value="AJOUTER" />
</div>
</form>
</div>
</div>
...
<h3 class="inner-tittle two">Liste des Professeurs/Enseignants <a href="#" name="listeProf">#</a></h3>
<div class="graph">
<div class="tables">
